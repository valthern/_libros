/*!
* DevExtreme (dx.messages.pt-PT.js)
* Version: 26.1.4
...
(function(root, factory) {
    ...
    localization.loadMessages({
        "pt-PT": {
            ...
            "dxList-pulledDownText": "Largar para recarregar...",
            ...
            "dxList-listAriaLabel-deletable": "Itens elimináveis",
            ...
            "dxScrollView-pulledDownText": "Largar para recarregar...",
            ...
            "dxDateRangeBox-endDateOutOfRangeMessage": "A data de fim está fora do intervalo",
            ...
            "dxFileUploader-dropFile": "ou Largar ficheiro aqui",
            "dxFileUploader-bytes": "bytes",
            "dxFileUploader-kb": "KB",
            "dxFileUploader-Mb": "MB",
            "dxFileUploader-Gb": "GB",
            "dxFileUploader-upload": "Carregamento",
            "dxFileUploader-uploaded": "Carregamento concluído",
            "dxFileUploader-readyToUpload": "Pronto para carregar",
            "dxFileUploader-uploadAbortedMessage": "Carregamento cancelado",
            "dxFileUploader-uploadFailedMessage": "Falha no carregamento",
            "dxFileUploader-invalidFileExtension": "Tipo de ficheiro não é permitido",
            "dxFileUploader-invalidMaxFileSize": "O ficheiro é muito grande",
            "dxFileUploader-invalidMinFileSize": "O ficheiro é muito pequeno",
            "dxFileUploader-fileListLabel": "Lista de ficheiros",
            "dxFileUploader-removeFileButtonLabel": "Remover ficheiro {0}",
            "dxFileUploader-uploadFileButtonLabel": "Carregar ficheiro {0}",
            ...
            "dxDataGrid-aiAssistantProcessingMessageHeader": "Pedido em curso",
            "dxDataGrid-aiAssistantProcessingMessage": "A processar...",
            "dxDataGrid-aiAssistantErrorMessageHeader": "Falha ao processar o pedido",
            "dxDataGrid-aiAssistantAbortMessage": "Pedido interrompido.",
            ...
            "dxDataGrid-aiAssistantExecutionInProgressMessage": "Execução já em curso. Aguarde.",
            "dxDataGrid-aiAssistantRequestInProgressMessage": "Pedido já em curso. Aguarde.",
            ...
            "dxDataGrid-aiAssistantAbortConfirmText": "Fechar o chat do Assistente de IA interrompe os pedidos em curso. Deseja fechar o chat?",
            ...
            "dxDataGrid-aiPromptEditorPlaceholder": "Peça à IA para gerar valores para as colunas...",
            ...
            "dxDataGrid-emptyHeaderWithColumnChooserText": "Use {0} para mostrar colunas",
            ...
            "dxDataGrid-editingConfirmDeleteMessage": "Tem a certeza de que deseja eliminar este registo?",
            ...
            "dxDataGrid-editingSaveAllChanges": "Guardar todas as alterações",
            ...
            "dxDataGrid-ariaAdaptiveExpand": "Mostrar dados adicionais",
            "dxDataGrid-ariaColumn": "Coluna",
            "dxDataGrid-ariaColumnHeader": "Cabeçalho da coluna",
            "dxDataGrid-ariaValue": "Valor",
            "dxDataGrid-ariaError": "Erro",
            "dxDataGrid-ariaRevertButton": "Prima Escape para descartar as alterações",
            ...
            "dxDataGrid-ariaDataGrid": "Grelha de dados com {0} linhas e {1} colunas",
            ...
            "dxDataGrid-ariaToolbar": "Barra de ferramentas da grelha de dados",
            ...
            "dxDataGrid-filterPanelFilterEnabledHint": "Ativar o filtro",
            ...
            "dxTreeList-ariaExpandableInstruction": "Prima Ctrl + seta para a direita para expandir o nó em foco e Ctrl + seta para a esquerda para recolhê-lo",
            ...
            "dxPager-nextPage": "Página seguinte",
            ...
            "dxPagination-nextPage": "Página seguinte",
            ...
            "dxScheduler-ariaLabel-currentIndicator-not-present": "O indicador de tempo atual não está visível no ecrã",
            "dxScheduler-appointmentAriaDescription-group": "Grupo: {0}",
            "dxScheduler-appointmentAriaLabel-recurring": "Compromisso recorrente",
            "dxScheduler-hotkeysAriaDescription-delete": "Prima Delete para eliminar este compromisso",
            "dxScheduler-hotkeysAriaDescription-homeEnd": "Prima Home ou End para navegar rapidamente para o primeiro ou último compromisso",
            ...
            "dxScheduler-editorAriaLabelEndTime": "Hora de fim",
            ...
            "dxScheduler-navigationNext": "Página seguinte",
            ...
            "dxScheduler-recurrenceUntilDateLabel": "Data de fim da repetição",
            ...
            "dxScheduler-confirmRecurrenceDeleteTitle": "Eliminar compromisso recorrente",
            ...
            "dxCalendar-nextMonthButtonLabel": "Mês seguinte",
            "dxCalendar-nextYearButtonLabel": "Ano seguinte",
            "dxCalendar-nextDecadeButtonLabel": "Década seguinte",
            "dxCalendar-nextCenturyButtonLabel": "Século seguinte",
            ...
            "dxCalendar-readOnlyLabel": "Calendário só de leitura",
            ...
            "dxCardView-emptyHeaderPanelText": "Use {0} para mostrar colunas",
            "dxCardView-emptyHeaderPanelColumnChooserText": "seletor de coluna",
            "dxAvatar-defaultImageAlt": "Avatar",
            "dxChat-elementAriaLabel": "Chat",
            "dxChat-textareaPlaceholder": "Escreva uma mensagem",
            ...
            "dxChat-defaultUserName": "Utilizador desconhecido",
            ...
            "dxChat-typingMessageSingleUser": "{0} está a escrever...",
            "dxChat-typingMessageTwoUsers": "{0} e {1} estão a escrever...",
            "dxChat-typingMessageThreeUsers": "{0}, {1} e {2} estão a escrever...",
            "dxChat-typingMessageMultipleUsers": "{0} e outros estão a escrever...",
            "dxChat-editedMessageText": "Editado",
            "dxChat-editingEditMessage": "Editar",
            "dxChat-editingDeleteMessage": "Eliminar",
            "dxChat-editingDeleteConfirmText": "Tem a certeza de que deseja eliminar esta mensagem?",
            "dxChat-deletedMessageText": "Esta mensagem foi eliminada",
            "dxChat-defaultImageAlt": "Imagem partilhada no chat",
            "dxChat-fileViewLabel": "Lista de ficheiros",
            "dxChat-downloadButtonLabel": "Transferir ficheiro {0}",
            "dxChat-fileLimitReachedWarning": "Selecionou demasiados ficheiros. Selecione, no máximo, {0} ficheiros e tente novamente.",
            ...
            "dxHtmlEditor-deleteColumn": "Eliminar coluna",
            "dxHtmlEditor-deleteRow": "Eliminar linha",
            "dxHtmlEditor-deleteTable": "Eliminar tabela",
            ...
            "dxFileManager-rootDirectoryName": "Ficheiros",
            ...
            "dxFileManager-errorFileExistsFormat": "O ficheiro '{0}' já existe.",
            "dxFileManager-errorFileNotFoundFormat": "Ficheiro '{0}' não encontrado.",
            "dxFileManager-errorDirectoryNotFoundFormat": "Diretório '{0}' não encontrado.",
            "dxFileManager-errorWrongFileExtension": "A extensão do ficheiro não é permitida.",
            "dxFileManager-errorMaxFileSizeExceeded": "O tamanho do ficheiro excede o tamanho máximo permitido.",
            ...
            "dxFileManager-commandDownload": "Transferir",
            "dxFileManager-commandUpload": "Carregar ficheiros",
            "dxFileManager-commandRefresh": "Atualizar",
            "dxFileManager-commandThumbnails": "Mostrar miniaturas",
            ...
            "dxFileManager-dialogDeleteItemSingleItemConfirmation": "Tem a certeza de que deseja eliminar {0}?",
            "dxFileManager-dialogDeleteItemMultipleItemsConfirmation": "Tem a certeza de que deseja eliminar {0} itens?",
            ...
            "dxFileManager-editingRenameSingleItemProcessingMessage": "A renomear um item dentro de {0}",
            ...
            "dxFileManager-editingDeleteSingleItemProcessingMessage": "A eliminar um item de {0}",
            "dxFileManager-editingDeleteMultipleItemsProcessingMessage": "A eliminar {0} itens de {1}",
            "dxFileManager-editingDeleteSingleItemSuccessMessage": "Eliminou um item de {0}",
            "dxFileManager-editingDeleteMultipleItemsSuccessMessage": "{0} itens eliminados de {1}",
            "dxFileManager-editingDeleteSingleItemErrorMessage": "O item não foi eliminado",
            "dxFileManager-editingDeleteMultipleItemsErrorMessage": "{0} itens não foram eliminados",
            "dxFileManager-editingDeleteCommonErrorMessage": "Alguns itens não foram eliminados",
            "dxFileManager-editingMoveSingleItemProcessingMessage": "A mover um item para {0}",
            "dxFileManager-editingMoveMultipleItemsProcessingMessage": "A mover {0} itens para {1}",
            ...
            "dxFileManager-editingCopySingleItemProcessingMessage": "A copiar um item para {0}",
            "dxFileManager-editingCopyMultipleItemsProcessingMessage": "A copiar {0} itens para {1}",
            ...
            "dxFileManager-editingUploadSingleItemProcessingMessage": "A carregar um item para {0}",
            "dxFileManager-editingUploadMultipleItemsProcessingMessage": "A carregar {0} itens para {1}",
            "dxFileManager-editingUploadSingleItemSuccessMessage": "Carregou um item para {0}",
            "dxFileManager-editingUploadMultipleItemsSuccessMessage": "Carregados {0} itens para {1}",
            ...
            "dxFileManager-editingDownloadSingleItemErrorMessage": "O item não foi transferido",
            "dxFileManager-editingDownloadMultipleItemsErrorMessage": "{0} itens não foram transferidos",
            "dxFileManager-listDetailsColumnCaptionName": "Nome",
            "dxFileManager-listDetailsColumnCaptionDateModified": "Data de modificação",
            "dxFileManager-listDetailsColumnCaptionFileSize": "Tamanho do ficheiro",
            ...
            "dxDiagram-categoryContainers": "Contentores",
            ...
            "dxDiagram-commandAlignCenter": "Centrar horizontalmente",
            ...
            "dxDiagram-commandConnectorLineArrow": "Seta",
            "dxDiagram-commandFullscreen": "Ecrã inteiro",
            ...
            "dxDiagram-commandShowGrid": "Mostrar grelha",
            "dxDiagram-commandSnapToGrid": "Ajustar à grelha",
            "dxDiagram-commandGridSize": "Tamanho da grelha",
            ...
            "dxDiagram-dialogEditShapeImageLabelText": "ou arraste um ficheiro aqui",
            "dxDiagram-uiExport": "Exportar",
            "dxDiagram-uiProperties": "Propriedades",
            "dxDiagram-uiSettings": "Definições",
            "dxDiagram-uiShowToolbox": "Mostrar ferramentas",
            "dxDiagram-uiSearch": "Pesquisar",
            "dxDiagram-uiStyle": "Estilo",
            "dxDiagram-uiLayout": "Esquema",
            ...
            "dxDiagram-shapeArrowLeft": "Seta à esquerda",
            "dxDiagram-shapeArrowUp": "Seta para cima",
            "dxDiagram-shapeArrowRight": "Seta à direita",
            "dxDiagram-shapeArrowDown": "Seta para baixo",
            "dxDiagram-shapeArrowUpDown": "Seta para cima e para baixo",
            "dxDiagram-shapeArrowLeftRight": "Seta à esquerda e direita",
            ...
            "dxDiagram-shapeContainerDefaultText": "Contentor",
            "dxDiagram-shapeVerticalContainer": "Contentor vertical",
            "dxDiagram-shapeHorizontalContainer": "Contentor horizontal",
            ...
            "dxGantt-dialogResourceManagerTitle": "Gestor de recursos",
            ...
            "dxGantt-contextMenuDeleteTask": "Eliminar tarefa",
            "dxGantt-contextMenuDeleteDependency": "Eliminar dependência",
            "dxGantt-dialogTaskDeleteConfirmation": "Eliminar uma tarefa também elimina as suas dependências e subtarefas. Tem a certeza de que quer eliminar essa tarefa?",
            "dxGantt-dialogDependencyDeleteConfirmation": "Tem a certeza de que quer eliminar a dependência desta tarefa?",
            "dxGantt-dialogResourcesDeleteConfirmation": "Ao eliminar o recurso, ele também será eliminado das tarefas em que está atribuído. Tem a certeza de que quer eliminar estes recursos? Recursos: {0}",
            "dxGantt-dialogConstraintCriticalViolationMessage": "A tarefa a ser movida está ligada a uma outra tarefa, por uma relação de dependência. Esta alteração conflita com as regras de dependências. Como gostaria de proceder?",
            "dxGantt-dialogConstraintViolationMessage": "A tarefa a ser movida está ligada a uma outra tarefa, por uma relação de dependência. Como gostaria de proceder?",
            "dxGantt-dialogCancelOperationMessage": "Cancelar operação",
            "dxGantt-dialogDeleteDependencyMessage": "Eliminar a dependência",
            "dxGantt-dialogMoveTaskAndKeepDependencyMessage": "Mover a tarefa e manter a dependência",
            "dxGantt-dialogConstraintCriticalViolationSeveralTasksMessage": "A tarefa que está a tentar mover está vinculada a outras tarefas por relações de dependência. Essa alteração entraria em conflito com as regras de dependência. Como gostaria de proceder?",
            "dxGantt-dialogConstraintViolationSeveralTasksMessage": "A tarefa que está a tentar mover está vinculada a outras tarefas por relações de dependência. Como gostaria de proceder?",
            "dxGantt-dialogDeleteDependenciesMessage": "Elimine as relações de dependência",
            ...
            "dxGantt-deleteSelectedTask": "Eliminar tarefas selecionadas",
            "dxGantt-zoomIn": "Aumentar zoom",
            "dxGantt-zoomOut": "Diminuir zoom",
            "dxGantt-fullScreen": "Ecrã inteiro",
            "dxGantt-quarter": "Q{0}",
            ...
            "dxGantt-dialogEndDateValidation": "A data de fim deve ser posterior a {0}",
            ...
            "dxSpeechToText-ariaLabelStart": "Prima para iniciar a transcrição de voz",
            "dxSpeechToText-ariaLabelStop": "Prima para parar a transcrição de voz"
        }
    });
}));
